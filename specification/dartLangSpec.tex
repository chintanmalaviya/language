...
!!!TODO!!! Use lexical lookup, and include special rule about access to
static extension instance member overriding acces to instance member. !!!
...
where $C$ is a type literal, or $C$ denotes a static extension.
...
\LMHash{}%
A compile-time error occurs
unless $C$ denotes a class, a mixin, or a static extension that declares
...
and does not denote a static extension.
...
\LMHash{}%
If $e$ is a type literal or $e$ denotes a static extension,
