...
\commentary{%
Specificity is used to determine which static extension method to execute
...
inside the same extension as an unqualified function invocation
...
and unless there are any other static extensions creating a conflict.
...
where a member of a static extension shadows
a regular instance member on \THIS.
In practice, static extensions will very rarely introduce members
