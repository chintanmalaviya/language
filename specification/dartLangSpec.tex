...
(\commentary{that is, \LET{} expressions can arise during desugaring}).
...
For type inference of $e_j$, the empty context type is used.
...
a static extension application with receiver $r$,
...
\commentary{%
Let $e_0$ be a static extension application
(\ref{staticExtensions}).
...
which is not a static extension application,
and $e$ is \code{$e_0$..$c_1\ \cdots\ $..$c_k$}.
In this case, $e$ is desugared to

\noindent
\code{\LET\ $v$\,\,=\,\,$e_0$, $v_1$\,\,=\,\,$v$.$c_1$,\ %
  \ldots,\ $v_k$\,\,=\,\,$v$.$c_k$\ \IN\ $v$}.
...
\noindent
\code{\LET\ $v$\,\,=\,\,$e_0$\ \IN\ $v$\,==\,\NULL\ ?\ \NULL\ :\ %
  \LET\ $v_1$\,\,=\,\,$v$.$c_1$,\ \ldots,\ $v_k$\,\,=\,\,$v$.$c_k$ \IN\ $v$}.
